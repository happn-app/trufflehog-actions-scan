...
if [ -n "${INPUT_GCLOUD_SERVICE_KEY}" ]; then
  githubRepo="https://$INPUT_GCLOUD_SERVICE_KEY@github.com/$GITHUB_REPOSITORY" # Overwrite for private repository if token provided
else
